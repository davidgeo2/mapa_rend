...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32615',
            extent: [512081.861300, 1664822.563300, 762842.935000, 2013088.385700],
            units: 'm'})
    })
});
...
map.getView().fit([-132891.416131, 1518016.099422, 1217519.779139, 2340794.104843], map.getSize());
